  ...
  return (
    ...
    <hr className="xl:my-3 my-2 border-t border-gray-200" />
        ...
        <div className='flex items-center justify-between'>
            ...
            {pathname.includes("/jobSeeker/job-details")? <><p className='text-primary underline'>View Details</p></>:<>            <button className='2xl:px-6 px-2 py-2 2xl:py-3 bg-primary rounded xl:text-base  text-xs text-white cursor-pointer hover:bg-green-600' >Apply Now</button>
</>}
        </div>
