            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full px-4 py-[17px] border rounded-lg focus:outline-none focus:ring-2 ${errors.email
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  type="password"
                  placeholder="••••••••"
                  className={`w-full px-4 py-[17px] border rounded-lg focus:outline-none focus:ring-2 ${errors.password
                      ? "border-red-500 focus:ring-red-200"
                      : "border-gray-300 focus:ring-blue-200"
                    }`}
                  {...register("password", {
