...
export default function JobCard({ job }: { job: Job }) {
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-4 hover:shadow-md transition-shadow w-full md:min-w-[666px]">
            ...
            <p className="text-sm text-gray-600 mb-4 border-b-2 border-t-2  flex items-center gap-3 py-3 border-gray-200">
                <span className="font-medium ">Skill Needed:</span> <div className='flex flex-wrap'>
